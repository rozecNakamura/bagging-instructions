...
public class BaggingOrderBasedRoundingTests
{
    ...
    [Fact]
    public void KiriUnit_no_seasoningBoms_splits_by_divisor()
    {
        // 単位"切": qty=130, spec=80 → stdBags=1, irregular=50
        var parent = new ItemDetailDto { Itemcd = "100", Uni = new UniDetailDto { Uninm = "切" } };
